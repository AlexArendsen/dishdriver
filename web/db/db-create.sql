...
CREATE TABLE Table_Reservations (
  ...
  DepositPayed INT(1)       NOT NULL DEFAULT 0,
...
CREATE TABLE Orders (
  ...
  DT_Placed   DATETIME      DEFAULT NULL,
...
CREATE TABLE Ordered_Dishes (
  ...
  IsVoided    INT(1)        NOT NULL DEFAULT 0,
  OrderedPrice INT          NOT NULL DEFAULT 0,
  NotesFromKitchen VARCHAR(255) DEFAULT NULL,
  NotesToKitchen   VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (ID),
